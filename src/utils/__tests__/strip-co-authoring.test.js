...
Co-authored-by: marry@peterpaulandmarry.com`
  expect(stripCoAuthorship(commitMsg)).toEqual('Commit message 1')
})
...
Co-authored-by: paul@peterpaulandmarry.com`
  expect(stripCoAuthorship(commitMsg)).toEqual('Commit message 2')
})
...
Acked-by: Marry <marry@peterpaulandmarry.com>`
  expect(stripCoAuthorship(commitMsg)).toEqual(commitMsg)
})
...
Co-authored-by: paul@peterpaulandmarry.com
Acked-by: Marry <marry@peterpaulandmarry.com>`
  expect(stripCoAuthorship(commitMsg)).toEqual(`Commit message 4
